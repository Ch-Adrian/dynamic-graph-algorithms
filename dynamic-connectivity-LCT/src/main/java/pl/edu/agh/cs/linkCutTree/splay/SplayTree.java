...
import pl.edu.agh.cs.linkCutTree.SelfBalancingTree;
...
//        treeNode.pathParent = treeNode.parent;
...
//        rightMostOfLeftTree.pathParent = leftTree.pathParent;
//        if(rightMostOfLeftTree.equals(leftTree)){
//            leftTree.pathParent = null;
//        }
//        rightTree.pathParent = null;
//        rightMostOfLeftTree.right.pathParent = null;
...
//    }
    ...
    public  Optional<Node> removeNode(Node treeNode){
        ...
        pred.pathParent = treeNode.pathParent;
        treeNode.pathParent = null;
